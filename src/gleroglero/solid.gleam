...
pub fn camera() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([
        attribute("d", "M12 9a3.75 3.75 0 1 0 0 7.5A3.75 3.75 0 0 0 12 9Z"),
      ]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
...
pub fn cpu_chip() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M16.5 7.5h-9v9h9v-9Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
...
pub fn credit_card() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([
        attribute("d", "M4.5 3.75a3 3 0 0 0-3 3v.75h21v-.75a3 3 0 0 0-3-3h-15Z"),
      ]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
...
pub fn device_tablet() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([
        attribute("d", "M10.5 18a.75.75 0 0 0 0 1.5h3a.75.75 0 0 0 0-1.5h-3Z"),
      ]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
...
pub fn eye() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
...
pub fn truck() -> Element(a) {
  svg.svg(
    ...
    [
      ...
      svg.path([
        attribute("d", "M19.5 19.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z"),
      ]),
    ],
  )
}
...
pub fn tv() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M19.5 6h-15v9h15V6Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
