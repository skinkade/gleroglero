    ...
    [
      ...
      svg.defs([], [
        element("clippath", [attribute.id("a")], [
          svg.path([attribute("d", "M0 0h20v20H0z")]),
        ]),
      ]),
    ],
  )
...
pub fn cpu_chip() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M14 6H6v8h8V6Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
...
pub fn document_magnifying_glass() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M8 10a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
...
pub fn eye() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M10 12.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
...
pub fn magnifying_glass_circle() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M6.5 9a2.5 2.5 0 1 1 5 0 2.5 2.5 0 0 1-5 0Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
...
pub fn microphone() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M7 4a3 3 0 0 1 6 0v6a3 3 0 1 1-6 0V4Z")]),
      svg.path([
        attribute(
          "d",
...
pub fn tv() -> Element(a) {
  svg.svg(
    ...
    [
      svg.path([attribute("d", "M4 5h12v7H4V5Z")]),
      svg.path([
        attribute("clip-rule", "evenodd"),
        attribute(
          "d",
